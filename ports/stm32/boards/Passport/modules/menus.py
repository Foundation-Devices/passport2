...
def device_menu():
    ...
    from utils import toggle_continuous_scroll, is_continuous_scroll
    ...
    return [
        ...
        {'icon': lv.ICON_HAMBURGER,
         'label': 'Continuous Scroll',
         'action': lambda item: toggle_continuous_scroll(),
         'is_toggle': True,
         'value': lambda: is_continuous_scroll()},
