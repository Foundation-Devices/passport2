...
PSBT_GLOBAL_TX_VERSION = const(2)
PSBT_GLOBAL_FALLBACK_LOCKTIME = const(3)
PSBT_GLOBAL_INPUT_COUNT = const(4)
PSBT_GLOBAL_OUTPUT_COUNT = const(5)
PSBT_GLOBAL_TX_MODIFIABLE = const(6)
PSBT_GLOBAL_SP_ECDH_SHARE = const(7)
PSBT_GLOBAL_SP_DLEQ = const(8)
PSBT_GLOBAL_VERSION = const(251)
...
PSBT_IN_PREVIOUS_TXID = const(14)
PSBT_IN_OUTPUT_INDEX = const(15)
PSBT_IN_SEQUENCE = const(16)
PSBT_IN_REQUIRED_TIME_LOCKTIME = const(17)
PSBT_IN_REQUIRED_HEIGHT_LOCKTIME = const(18)
PSBT_IN_SP_ECDH_SHARE = const(29)
PSBT_IN_SP_DLEQ = const(30)

PSBT_OUT_REDEEM_SCRIPT = const(0)
PSBT_OUT_WITNESS_SCRIPT = const(1)
PSBT_OUT_BIP32_DERIVATION = const(2)
PSBT_OUT_AMOUNT = const(3)
PSBT_OUT_SCRIPT = const(4)
PSBT_OUT_TAP_INTERNAL_KEY = const(5)
PSBT_OUT_TAP_TREE = const(6)
PSBT_OUT_TAP_BIP32_DERIVATION = const(7)
PSBT_OUT_SP_V0_INFO = const(9)
PSBT_OUT_SP_V0_LABEL = const(10)
