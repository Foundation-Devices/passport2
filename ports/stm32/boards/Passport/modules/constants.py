...
CARD_CONTENT_HEIGHT_WITHOUT_HEADER = (
    320 - STATUS_BAR_HEIGHT - CARD_CHEVRON_HEIGHT - CARD_PAD_BOTTOM) + CARD_EXTRA_HEIGHT
...
def set_gen1_constants():
    ...
    global CARD_CONTENT_HEIGHT_WITHOUT_HEADER, CARD_CONTENT_HEIGHT_WITH_HEADER
    ...
    CARD_CONTENT_HEIGHT_WITHOUT_HEADER = 303 - STATUS_BAR_HEIGHT - CARD_CHEVRON_HEIGHT - CARD_BOTTOM_MARGIN
    CARD_CONTENT_HEIGHT_WITH_HEADER = CARD_CONTENT_HEIGHT_WITHOUT_HEADER - CARD_HEADER_HEIGHT
