...
const LV_ATTRIBUTE_MEM_ALIGN LV_ATTRIBUTE_LARGE_CONST LV_ATTRIBUTE_IMG_ICON_INPUT_MODE_LOWER_ALPHA uint8_t ICON_INPUT_MODE_LOWER_ALPHA_map[] = {
  0x00, 0x00, 0x00, 0x00, 	/*Color of index 0*/
  0xfe, 0xfe, 0xfe, 0xec, 	/*Color of index 1*/
