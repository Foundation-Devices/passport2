...
freeze('$(MPY_DIR)/ports/stm32/boards/Passport/modules',
       ('pages/__init__.py',
        ...
        'pages/seed_length_chooser_page.py',
...
freeze('$(MPY_DIR)/ports/stm32/boards/Passport/modules',
       ('tasks/__init__.py',
        ...
        'tasks/import_multisig_config_task.py',
        'tasks/login_task.py',
        'tasks/lvgl_task.py',
        'tasks/main_task.py',
        ...
        'tasks/write_data_to_file_task.py'))
