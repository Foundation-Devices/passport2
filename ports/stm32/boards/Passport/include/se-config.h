...
#define SE_CHIP_CONFIG_1 { \
	...
	0x00, 0x00, 0xc3, 0x43, 0x00, 0x43, 0xce, 0x4e, 0x00, 0x00,   \
...
#define SE_CHIP_CONFIG_2 { \
	...
	0xbc, 0x01, 0x3c, 0x00, 0xdc, 0x03, 0x9c, 0x01, 0xdc, 0x01,   \
...
#define KEYNUM_firmware_timestamp  	11
...
KeyConfig[10] = 0x9c01 = KeyConfig(Private=0, PubInfo=0, KeyType=7, Lockable=0, ReqRandom=0, ReqAuth=1, AuthKey=1, PersistentDisable=0, RFU=0, X509id=0)=0x019c
     ...
     Slot[11] = 0xce4e = SlotConfig(ReadKey=14, NoMac=0, LimitedUse=0, EncryptRead=1, IsSecret=1, WriteKey=14, WriteConfig=4)=0x4ece
KeyConfig[11] = 0xdc01 = KeyConfig(Private=0, PubInfo=0, KeyType=7, Lockable=0, ReqRandom=1, ReqAuth=1, AuthKey=1, PersistentDisable=0, RFU=0, X509id=0)=0x01dc
