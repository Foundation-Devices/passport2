...
FOUNDATION_RUST_SRC ?= $(wildcard $(FOUNDATION_RUST)/src/*.rs) \
	...
	$(FOUNDATION_RUST)/bindings/Cargo.toml \
	$(FOUNDATION_RUST)/bindings/cbindgen.toml

FOUNDATION_RUST_LIB ?= $(FOUNDATION_RUST)/target/$(RUST_TARGET)/release/libfoundation.a

CFLAGS_MOD += -I$(FOUNDATION_RUST)/bindings/include
...
$(FOUNDATION_RUST_LIB): $(FOUNDATION_RUST_SRC)
	...
	cargo build --manifest-path $(FOUNDATION_RUST)/bindings/Cargo.toml --target $(RUST_TARGET) $(RUST_FEATURES) --release
