...
typedef enum {
    ...
    LV_STYLE_IMG_OPA                 = 70,
    // FOUNDATION CHANGE
    LV_STYLE_IMG_RECOLOR             = 71 | LV_STYLE_PROP_INHERIT,
    LV_STYLE_IMG_RECOLOR_FILTERED    = 71 | LV_STYLE_PROP_FILTER | LV_STYLE_PROP_INHERIT,
    LV_STYLE_IMG_RECOLOR_OPA         = 72 | LV_STYLE_PROP_INHERIT,
    // FOUNDATION CHANGE
